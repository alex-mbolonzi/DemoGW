...
describe('Book Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Author query and add missing value', () => {
      ...
      const authorBook: IAuthor = { id: 47336 };
      ...
      const additionalAuthors = [authorBook];
    ...
    it('Should update editForm', () => {
      const book: IBook = { id: 456 };
      const authorBook: IAuthor = { id: 5685 };
      book.authorBook = authorBook;
      ...
      expect(comp.authorsSharedCollection).toContain(authorBook);
    });
  });
